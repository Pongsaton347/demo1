...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      {
        path: "/apps/customers/customer-details1",
        name: "apps-customers-details1",
        component: () => import("@/views/apps/customers/CustomerDetails1.vue"),
        meta: {
          pageTitle: "Customers Details",
          breadcrumbs: ["Apps", "Customers"],
        },
      ...
      {
        path: "/crafted/rfid/department",
        name: "rfid-department",
        component: () => import("@/views/crafted/rfid/department.vue"),
        meta: {
          pageTitle: "Department",
          breadcrumbs: ["Crafted", "rfid"],
        },
      },
      {
        path: "/crafted/rfid/employee",
        name: "rfid-employee",
        component: () => import("@/views/crafted/rfid/employee.vue"),
        meta: {
          pageTitle: "Employee",
          breadcrumbs: ["Crafted", "rfid"],
        },
      ...
      {
        path: "/crafted/rfid/employee-details",
        name: "crefted-employee-detail",
        component: () => import("@/views/crafted/rfid/EmployeeDetail.vue"),
        meta: {
      ...
      {
        path: "/crafted/rfid/TestApp",
        name: "TestApp",
        component: () => import("@/views/crafted/rfid/Test.vue"),
        meta: {
          pageTitle: "",
          breadcrumbs: ["Crafted", "rfid"],
        },
      },
      {
        path: "/crafted/rfid",
        name: "account",
        component: () => import("@/views/crafted/rfid/Account.vue"),
        meta: {
          breadcrumbs: ["Crafted", "Account"],
        },
        children: [
          {
            path: "overview",
            name: "account-overview",
            component: () => import("@/views/crafted/rfid/Overview.vue"),
            meta: {
              pageTitle: "Overview",
            },
          },
          {
            path: "settings",
            name: "account-settings",
            component: () => import("@/views/crafted/rfid/Settings.vue"),
            meta: {
              pageTitle: "Settings",
            },
          },
